...
**Group:** Windows · **Improves:** Disk & Filesystem · **Risk:** Moderate · **Evidence:** Plausible · **Scope:** Machine · **Reboot:** yes

> Removes bookkeeping NTFS does on every file operation for the sake of software that is no longer here.
